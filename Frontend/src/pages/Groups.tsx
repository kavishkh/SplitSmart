import { Plus, Users, Search, Filter, X, RefreshCw } from "lucide-react";
      ...
      <Dialog open={showFilterModal} onOpenChange={setShowFilterModal}>
        <DialogContent className="sm:max-w-xs">
          ...
          <div className="space-y-3 py-2">
            ...
            <div className="space-y-1.5">
              ...
              <Select value={filters.balanceFilter} onValueChange={(value) => setFilters(prev => ({ ...prev, balanceFilter: value }))}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="settled" className="text-sm">Settled (No Balance)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            {/* Member Count Filter */}
            <div className="space-y-1.5">
              <Label htmlFor="memberCount" className="text-xs">Group Size</Label>
              <Select value={filters.memberCount} onValueChange={(value) => setFilters(prev => ({ ...prev, memberCount: value }))}>
                ...
                <SelectContent>
                  <SelectItem value="all" className="text-sm">All Sizes</SelectItem>
          ...
          <DialogFooter className="flex space-x-2 pt-2">
            <Button variant="outline" size="sm" onClick={resetFilters} className="flex-1 h-8 text-sm">
              Reset
            </Button>
            <Button size="sm" onClick={() => setShowFilterModal(false)} className="flex-1 h-8 text-sm">
              Apply
            </Button>
          </DialogFooter>
        </DialogContent>
