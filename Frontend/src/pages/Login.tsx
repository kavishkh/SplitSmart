  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (newUser) {
        ...
        // Wait a moment for the user to see the success message, then log them in
        setTimeout(async () => {
          ...
          if (!loginSuccess) {
            ...
            setIsSuccess(false);
            // Switch to login tab
            const tabTrigger = document.querySelector('[data-tab="login"]') as HTMLElement;
            if (tabTrigger) {
              tabTrigger.click();
            }
          }
          // If login is successful, the AuthContext will handle navigation to the dashboard
        }, 1500);
      } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Feature highlights matching website style */}
